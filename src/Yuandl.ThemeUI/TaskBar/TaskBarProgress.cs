...
namespace Yuandl.ThemeUI.TaskBar;
...
public static class TaskBarProgress
{
    ...
    {
        return Win32Utilities.IsOSWindows7OrNewer;
    }
    ...
    public static bool SetState(IntPtr hWnd, TaskBarProgressState taskBarProgressState)
    {
        ...
        return NativeMethodsExtension.SetTaskbarState(hWnd, UnsafeReflection.Cast(taskBarProgressState));
    }
    ...
    )
    {
        ...
        return NativeMethodsExtension.SetTaskbarValue(
            hWnd,
