...
public class TitleBarButton : Yuandl.ThemeUI.Controls.Button
{
    ...
    private Dwmapi.WM_NCHITTEST _returnValue;
    ...
    internal bool ReactToHwndHook(Dwmapi.WM msg, IntPtr lParam, out IntPtr returnIntPtr)
    {
        returnIntPtr = IntPtr.Zero;

        switch (msg)
        {
            case Dwmapi.WM.NCHITTEST:
                ...
                RemoveHover();
                return false;
            case Dwmapi.WM.NCMOUSELEAVE: // Mouse leaves the window
                RemoveHover();
                return false;
            case Dwmapi.WM.NCLBUTTONDOWN when this.IsMouseOverElement(lParam): // Left button clicked down
                _isClickedDown = true;
                return true;
            case Dwmapi.WM.NCLBUTTONUP when _isClickedDown && this.IsMouseOverElement(lParam): // Left button clicked up
                InvokeClick();
                return true;
            default:
                return false;
    ...
    protected void OnButtonTypeChanged(DependencyPropertyChangedEventArgs e)
    {
        ...
        {
            TitleBarButtonType.Unknown => Dwmapi.WM_NCHITTEST.HTNOWHERE,
            TitleBarButtonType.Help => Dwmapi.WM_NCHITTEST.HTHELP,
            TitleBarButtonType.Minimize => Dwmapi.WM_NCHITTEST.HTMINBUTTON,
            TitleBarButtonType.Close => Dwmapi.WM_NCHITTEST.HTCLOSE,
            TitleBarButtonType.Restore => Dwmapi.WM_NCHITTEST.HTMAXBUTTON,
            TitleBarButtonType.Maximize => Dwmapi.WM_NCHITTEST.HTMAXBUTTON,
            _
