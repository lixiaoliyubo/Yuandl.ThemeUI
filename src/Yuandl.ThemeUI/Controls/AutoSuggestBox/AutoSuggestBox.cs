...
public class AutoSuggestBox : System.Windows.Controls.ItemsControl, IIconControl
{
    ...
    protected System.Windows.Controls.ListView? SuggestionsList { get; set; } = null!;
    ...
    public override void OnApplyTemplate()
    {
        ...
        SuggestionsList = GetTemplateChild<System.Windows.Controls.ListView>(ElementSuggestionsList);
    ...
    {
        if (e.NewFocus is System.Windows.Controls.ListView)
        {
            return;
        }
    ...
    {
        if (e.NewFocus is System.Windows.Controls.ListViewItem)
        {
            return;
        }
    ...
    private IntPtr Hook(IntPtr hwnd, int msg, IntPtr wparam, IntPtr lparam, ref bool handled)
    {
        ...
        if (message is Dwmapi.WM.NCACTIVATE or Dwmapi.WM.WINDOWPOSCHANGED)
        {
            SetCurrentValue(IsSuggestionListOpenProperty, false);
        }
