...
public static class WindowBackdrop
{
    ...
    public static bool IsSupported(WindowBackdropType backdropType)
    {
        ...
        {
            WindowBackdropType.Auto => Win32Utilities.IsOSWindows11Insider1OrNewer,
            WindowBackdropType.Tabbed => Win32Utilities.IsOSWindows11Insider1OrNewer,
            WindowBackdropType.Mica => Win32Utilities.IsOSWindows11OrNewer,
            WindowBackdropType.Acrylic => Win32Utilities.IsOSWindows7OrNewer,
    ...
    public static bool ApplyBackdrop(IntPtr hWnd, WindowBackdropType backdropType)
    {
        ...
        {
            _ = NativeMethodsExtension.ApplyWindowDarkMode(hWnd);
        }
        else
        {
            _ = NativeMethodsExtension.RemoveWindowDarkMode(hWnd);
        }

        _ = NativeMethodsExtension.RemoveWindowCaption(hWnd);
